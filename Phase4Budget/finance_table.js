...
function ShowEdit() {
    ...
    for( var i = 0; i < myData.length; i++){ 
        ...
        if ( myData[i].dealId === Id) { 
            ...
            document.getElementById("costEdit").value = myData[i].project_cost;
...
function EditRow() {
    var dealid = document.getElementById("dealidedit").value;
    var projectCost = document.getElementById("costEdit").value
    ...
    for( var i = 0; i < myData.length; i++){ 
        ...
        if ( myData[i].dealId === Id) { 
            if(projectCost!=""){
                ...
                var clientName = myData[i].client_name;
                var projectName = myData[i].project_name;
                var projectManager = myData[i].project_manager;
