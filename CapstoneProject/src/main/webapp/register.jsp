		...
		<form name='register' action="/register" method='POST'>
			<table>
				...
				<tr>
					...
					<td><input type='password' name='confirm_password' style="width: 500px;"/></td>
				</tr>
				<tr>
					<td style="color: white;">Enter a Credit Card:</td>
					<td><input type='text' name='cardnumber' style="width: 500px;"/></td>
				</tr>
				<tr>
					<td colspan="2">
