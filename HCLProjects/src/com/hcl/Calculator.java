...
public class Calculator {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("Type + for addition, - for subtraction, x for multiply, / for division, or ^ for power.");
			...
			float answer=(float)z; //type casting for shorter answer
			
			System.out.println(x + " " + operation + " " + y + " = " + answer);
